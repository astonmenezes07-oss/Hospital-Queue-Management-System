...
import { loginPatient, simulateGoogleAuth, getCurrentSession } from '@/lib/auth';
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-border/50 p-8">
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-3 bg-white text-text-muted">or sign in with username</span>
            </div>
          </div>
          ...
          <div className="mt-4 p-3 rounded-lg bg-surface-secondary border border-border/50">
            <p className="text-xs text-text-muted text-center">
              <span className="font-medium">Demo:</span> username{' '}
              <code className="px-1 py-0.5 rounded bg-brand-50 text-brand text-xs">johnsmith</code>{' '}
              / password{' '}
              <code className="px-1 py-0.5 rounded bg-brand-50 text-brand text-xs">password123</code>
            </p>
          </div>
        </div>
