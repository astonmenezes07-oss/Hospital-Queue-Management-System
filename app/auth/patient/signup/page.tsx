...
import { signupPatient, loginPatient, simulateGoogleAuth, getCurrentSession } from '@/lib/auth';
...
export default function PatientSignup() {
  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    setTimeout(() => {
      ...
      const loginResult = loginPatient(form.username.trim().toLowerCase(), form.password);
      if (loginResult.ok) {
      ...
      <div className="w-full max-w-md animate-fade-in-up">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-border/50 p-8">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl border-2 border-border hover:border-brand/30 bg-white hover:bg-surface-hover text-sm font-medium text-text-primary transition-all duration-200 disabled:opacity-50 mb-6"
          >
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-3 bg-white text-text-muted">or register with email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-3.5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 rounded-xl bg-brand hover:bg-brand-dark text-white text-sm font-semibold transition-all duration-200 disabled:opacity-50 shadow-sm hover:shadow-md mt-2"
            >
          ...
          <p className="text-center text-sm text-text-secondary mt-6">
            ...
            <Link href="/auth/patient/login" className="text-brand font-medium hover:underline">
              Sign In
            </Link>
          </p>
        </div>
